...
| --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Wanxiang desktop rail is approximately `83px`                   | Use the shadcn Sidebar at approximately `112px` visible width with `80x64px` labeled targets. Keep `12px` between primary items and a restrained `24-28px` grouped gap before Assets; do not shrink it back to a dense 32px icon rail. |
